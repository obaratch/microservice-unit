...
## 直近の検証
- 2026-05-16: `git pull` のコンフリクトを incoming 側採用で解決し、merge commit `387a0f4` を作成。`main` へ直接 push できないため `merge-origin-main` ブランチを作成し、`origin/merge-origin-main` へ push 済み。
